...
public class AppUtil {
    ...
    public static Category tabelKatagori;
    public void setKatagori (Category katagori){
        tabelKatagori = katagori;
    }
    public static Category getKatagori (){
        return tabelKatagori;
    }
